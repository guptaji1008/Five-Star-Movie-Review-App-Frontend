...
const SearchResults = ({
  ...
  return (
    <div className="absolute z-50 right-0 left-0 top-10 bg-white dark:bg-gray-800 shadow-md p-2 max-h-56 space-y-2 overflow-scroll custom-scroll-bar dark:text-white text-primary">
